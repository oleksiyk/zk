...
var _messages = {
    ...
    '-120' : 'No quorum of new config is connected and up-to-date with the leader of last commmitted config - \
        try invoking reconfiguration after new servers are connected and synced',
    '-121' : 'Reconfiguration requested while another reconfiguration is currently in progress. This is currently \

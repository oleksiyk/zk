...
Zookeeper.prototype.get = function(path, watch) {
    ...
    return new Promise(function(resolve, reject) {
        if(!watch){
            ...
            self.zk.aw_get(path, function(type, state, _path) {
                if(_path === path){
                    resolver.resolve({
...
Zookeeper.prototype.exists = function(path, watch) {
    ...
    return new Promise(function(resolve, reject) {
        if (!watch) {
            ...
            var resolver = Promise.defer()
            self.zk.aw_exists(path, function(type, state, _path) {
                if(_path === path){
                    resolver.resolve({
                        type: _zkWatchEventTypes[type],
                        state: _zkStates[state],
...
Zookeeper.prototype.getChildren = function(path, watch) {
    ...
    return new Promise(function(resolve, reject) {
        if (!watch) {
            ...
            var resolver = Promise.defer()
            self.zk.aw_get_children(path, function(type, state, _path) {
                if(_path === path){
                    resolver.resolve({
                        type: _zkWatchEventTypes[type],
                        state: _zkStates[state],
...
Zookeeper.prototype.getChildren2 = function(path, watch) {
    ...
    return new Promise(function(resolve, reject) {
        if (!watch) {
            ...
            var resolver = Promise.defer()
            self.zk.aw_get_children2(path, function(type, state, _path) {
                if(_path === path){
                    resolver.resolve({
                        type: _zkWatchEventTypes[type],
                        state: _zkStates[state],
